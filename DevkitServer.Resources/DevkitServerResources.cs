...
internal class DevkitServerResources
{
    ...
    public List<IDevkitServerResource> Resources = new List<IDevkitServerResource>
    {
        ...
        new DevkitServerFileResource(Path.Combine("Defaults", "server_config.json"), new Version(0, 0, 26, 0)) { Side = Side.Server },
        ...
        new DevkitServerFileResource(Path.Combine("Schemas", "server_config_schema.json"), new Version(0, 0, 26, 0)) { Side = Side.Server },
