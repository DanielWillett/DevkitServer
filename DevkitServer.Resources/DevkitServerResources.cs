...
internal class DevkitServerResources
{
    ...
    public List<IDevkitServerResource> Resources = new List<IDevkitServerResource>
    {
        ...
        new DevkitServerFileResource("devkitserver.masterbundle", @"Bundles\devkitserver.masterbundle", new Version(0, 0, 1, 0)),
        new DevkitServerFileResource("devkitserver.masterbundle.hash", @"Bundles\devkitserver.masterbundle.hash", new Version(0, 0, 1, 0)),
        new DevkitServerFileResource("devkitserver.masterbundle.manifest", @"Bundles\devkitserver.masterbundle.manifest", new Version(0, 0, 1, 0)),
        new DevkitServerFileResource("devkitserver_linux.masterbundle", @"Bundles\devkitserver_linux.masterbundle", new Version(0, 0, 1, 0)),
        new DevkitServerFileResource("devkitserver_linux.masterbundle.manifest", @"Bundles\devkitserver_linux.masterbundle.manifest", new Version(0, 0, 1, 0)),
        new DevkitServerFileResource("devkitserver_mac.masterbundle", @"Bundles\devkitserver_mac.masterbundle", new Version(0, 0, 1, 0)),
        new DevkitServerFileResource("devkitserver_mac.masterbundle.manifest", @"Bundles\devkitserver_mac.masterbundle.manifest", new Version(0, 0, 1, 0)),
