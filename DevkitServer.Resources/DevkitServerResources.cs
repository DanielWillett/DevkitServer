...
internal class DevkitServerResources
{
    ...
    public List<IDevkitServerResource> Resources = new List<IDevkitServerResource>
    {
        ...
        // Bundles
        new DevkitServerFileResource(Path.Combine("Bundles", "MasterBundle.dat"), new Version(0, 0, 1, 0)),
        new DevkitServerFileResource("devkitserver.masterbundle", Path.Combine("Bundles", "devkitserver.masterbundle"), new Version(0, 0, 6, 0)),
        new DevkitServerFileResource("devkitserver.masterbundle.hash", Path.Combine("Bundles", "devkitserver.masterbundle.hash"), new Version(0, 0, 6, 0)),
        new DevkitServerFileResource("devkitserver.masterbundle.manifest", Path.Combine("Bundles", "devkitserver.masterbundle.manifest"), new Version(0, 0, 6, 0)),
        new DevkitServerFileResource("devkitserver_linux.masterbundle", Path.Combine("Bundles", "devkitserver_linux.masterbundle"), new Version(0, 0, 6, 0)),
        new DevkitServerFileResource("devkitserver_linux.masterbundle.manifest", Path.Combine("Bundles", "devkitserver_linux.masterbundle.manifest"), new Version(0, 0, 6, 0)),
        new DevkitServerFileResource("devkitserver_mac.masterbundle", Path.Combine("Bundles", "devkitserver_mac.masterbundle"), new Version(0, 0, 6, 0)),
        new DevkitServerFileResource("devkitserver_mac.masterbundle.manifest", Path.Combine("Bundles", "devkitserver_mac.masterbundle.manifest"), new Version(0, 0, 6, 0)),

        // Data
        new DevkitServerFileResource(Path.Combine("Data", "Object Icon Presets (Vanilla).json"), new Version(0, 0, 1, 0)),

        // Libraries
        new DevkitServerFileResource(Path.Combine("Libraries", "Library Info.txt"), new Version(0, 0, 1, 0)),
        ...
        new DevkitServerFileResource(Path.Combine("Libraries", "StackCleaner.dll"), new Version(0, 0, 1, 0)),
        new DevkitServerFileResource("StackCleaner.pdb", Path.Combine("Libraries", "StackCleaner.pdb"), new Version(0, 0, 1, 0)),
        new DevkitServerFileResource("StackCleaner.xml", Path.Combine("Libraries", "StackCleaner.xml"), new Version(0, 0, 1, 0)),
        ...
        new DevkitServerFileResource(Path.Combine("Libraries", "System.Numerics.Vectors.dll"), new Version(0, 0, 1, 0)),
        ...
        new DevkitServerFileResource(Path.Combine("Libraries", "System.Text.Json.dll"), new Version(0, 0, 1, 0)),
        ...
        new DevkitServerFileResource(Path.Combine("Libraries", "UniTask.dll"), new Version(0, 0, 1, 0)),
        new DevkitServerFileResource("UniTask.pdb", Path.Combine("Libraries", "UniTask.pdb"), new Version(0, 0, 1, 0)),
        new DevkitServerFileResource("UniTask.xml", Path.Combine("Libraries", "UniTask.xml"), new Version(0, 0, 1, 0)),
        new DevkitServerFileResource(Path.Combine("Libraries", "UniTask.dll license.txt"), new Version(0, 0, 1, 0))
    };
}
