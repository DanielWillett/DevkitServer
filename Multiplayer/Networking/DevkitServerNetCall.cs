...
public enum DevkitServerNetCall : ushort
{
    ...
    SendStartLargeTransmission = 52,
    SendLargeTransmissionPacket = 53,
    SendEndLargeTransmission = 54,
    SendMissedLargeTransmissionPackets = 55,
    SendLargeTransmissionCheckup = 56
}
