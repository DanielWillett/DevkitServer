...
public class PermissionGroupsConfig : JsonConfigurationFile<List<PermissionGroup>>
{
    public override List<PermissionGroup>? Default { get; } = new List<PermissionGroup>(4)
    {
        ...
        new PermissionGroup("terrain_editor", "Terrain Editor", new Color32(51, 204, 51, 255), 1, new GroupPermission[]
        {
            ...
            VanillaPermissions.BakeMapImages,
            VanillaPermissions.MoveSavedObjects,
            VanillaPermissions.PlaceRoads,
            VanillaPermissions.BakeRoads,
            VanillaPermissions.PlaceVolumes,
            VanillaPermissions.MoveSavedVolumes,
            VanillaPermissions.RemoveSavedVolumes,
            VanillaPermissions.PlaceNodes,
            VanillaPermissions.MoveSavedNodes,
            VanillaPermissions.RemoveSavedNodes,
            VanillaPermissions.PlacePlayerSpawns,
            VanillaPermissions.MoveSavedPlayerSpawns,
            VanillaPermissions.RemoveSavedPlayerSpawns,
        ...
        new PermissionGroup("location_builder", "Location Builder", new Color32(255, 255, 153, 255), 1, new GroupPermission[]
        {
            ...
            VanillaPermissions.BakeFoliageNearby,
            VanillaPermissions.BakeMapImages,
            VanillaPermissions.PlaceObjects,
            VanillaPermissions.RemoveSavedObjects,
            VanillaPermissions.MoveSavedObjects,
            VanillaPermissions.PlaceRoads,
            VanillaPermissions.BakeRoads,
            VanillaPermissions.PlaceVolumes,
        ...
        new PermissionGroup("director", "Director", new Color32(51, 204, 255, 255), 1, new GroupPermission[]
        {
